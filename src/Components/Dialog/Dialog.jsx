...
import { FormSelect, FormControl, FormLabel, Container, Row, Col } from "react-bootstrap";
...
function Dialog() {
    ...
    return (
        <Container className="dialog">
            {catalog && (
                <div>
                    <FormSelect aria-label="Default select example" onChange={handleTableChange} value={selectedTable}>
...
{selectedTable && (
        <div className="dialog__content">
          <div className="dialog__content__title text-light rounded m-4">{selectedTable}</div>
